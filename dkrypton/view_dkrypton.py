...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textedit_can_analyse.setGeometry(QtCore.QRect(x2, 320, 400, 100))
        ...
        self.graphics_can_analyse = QtWidgets.QGraphicsView(parent=self.tab_can)
        self.graphics_can_analyse.setGeometry(QtCore.QRect(x2, 400, 400, 100))
